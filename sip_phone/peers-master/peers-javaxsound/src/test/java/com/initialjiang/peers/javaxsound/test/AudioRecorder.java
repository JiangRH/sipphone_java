...
public class AudioRecorder extends JFrame {
	...
	public AudioRecorder() {// constructor
		...
		stopBtn.setEnabled(false); // Register anonymous listeners
	...
	private void captureAudio() {
		...
		try {
			...
			// Create a thread to capture the microphone data into an audio file and start the
			// thread running. It will run until the Stop button is clicked. This method
...
//		return new AudioFormat(sampleRate, sampleSizeInBits, channels, signed, bigEndian);
		return new AudioFormat(AudioFormat.Encoding.PCM_SIGNED, 44100F, 16, 2, 4, 44100F, true);
	}// end getAudioFormat
	...
	class CaptureThread extends Thread {
		public void run() {
			...
			File audioFile = null;
			// Set the file type and the file extension based on the selected
			// radio button.
