...
/**
 * 运行方法：Menu Run > Run Configurations… > Arguments Tab > Program arguments: ..
 * 	
 * 	填入自己peers.xml 的路径：	比如我这里是
 * 		 D:\Users\rhjiang\Downloads\sip-phone\peers-master\
 * 
 * 源码来自于： git clone https://github.com/ymartineau/peers.git
 * 
 */
public class MainFrame implements WindowListener, ActionListener {
    ...
    public MainFrame(final String[] args) {
        ...
        uri = new JTextField("sip:1022@10.2.32.142", 15);
