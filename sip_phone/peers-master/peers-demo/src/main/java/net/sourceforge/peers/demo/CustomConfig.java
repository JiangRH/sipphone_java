...
public class CustomConfig implements Config {
    ...
    public InetAddress getLocalInetAddress() {
        ...
        try {
            ...
            inetAddress = InetAddress.getByName("10.32.26.17");
    ...
    @Override public String getUserPart() { return "1989"; }
    @Override public String getDomain() { return "10.2.32.142"; }
    @Override public String getPassword() { return "456321"; }
    @Override
